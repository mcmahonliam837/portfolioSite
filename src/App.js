...
function App() {
  ...
  return (
    <div className="App">
      ...
      <ParallaxArea title='BUILDING THE FUTURE TODAY' subtitle='WITH EFFICIENT, POWERFUL, AND ELEGANT SOLUTIONS' logo={logo} bg={bg} />
      ...
      <EmailForm visable={emailPopupVis.visable} close={() => { setEmailPopupVis({ visable: false }) }} />
      ...
      <div id='contact_area'>
        ...
        <div>
          <div className="socialMedia">
            ...
            <ul>
              ...
              <li>
                <a href="https://ca.linkedin.com/in/lmmcmahon" target="_blank" rel="noopener noreferrer">
        ...
        <div>
          <div className="email">
            <h1>Shoot me an email <span className="highlight btn" onClick={() => {
              setEmailPopupVis({ visable: true });
            }}>here!</span></h1>
          </div>
        </div>
            ...
            <table>
              ...
              <tbody>
                <tr>
                  ...
                  <th>CODED WITH <span className="highlight">&#9829;</span> BY LIAM MCMAHON</th>
                </tr>
              </tbody>
